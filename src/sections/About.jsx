...
export default function About() {
  ...
  return (
    <section id="about"
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col">
        ...
        >
          ...
          >
            <img src={ph} alt="profile" className="absolute inset-0 w-full h-full object-cover" />
          </motion.div>
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build scalable, modern applications with a strong focus on clean architecture, delightful UX,
              and performance. My toolkit spans Java, React, Next.js, TypeScript, Tailwind CSS, and RESTful APIs — bringing
              ideas to life from concept to production with robust architectures and smooth interfaces.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                ...
                text-black font-semibold px-5 py-3 hover:bg-gray-200 transition">View Projects</a>
        ...
        <motion.div className="mt-12 text-center md:text-left"
        ...
        >
              ...
              <p className="text-gray-300 leading-relaxed text-base sm:text-lg">I'm a Software Developer, Content Creator, and Web Developer — passionate about building fast, resilient
                applications and sharing coding insights with the developer community.
              </p>
              <p className="mt-4 text-gray-400 text-base sm:text-lg">I love turning ideas into scalable, user-friendly products that make a real impact.</p>
        </motion.div>
